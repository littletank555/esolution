      ...
      <a-card class="a-card">
        ...
        <a-table bordered :dataSource="dataSource" :columns="columns" :pagination="false">
          <template slot="sub_name" slot-scope="text,record">
            ...
            <a-select v-model="record.sub_name">
              <a-select-option
                v-for="contractor in contractorname"
                :key="contractor.sub_contract_id"
              >{{contractor_name}}</a-select-option>
            </a-select>
          </template>
        ...
        .then(res => {
          ...
          res.list.forEach(element => {
            ...
            list.push({
              ...
              itemkey: element.get_sub_contractor_id
            });
          });
