  ...
  >
    <div class="new_client_data_container">
      ...
      <a-collapse accordion>
        ...
        <a-collapse-panel v-if="record.meta.length < 2" header="客戶聯絡人2" :key="2">
          <p class="item">
            <span class="label">聯絡人姓名</span>
            <a-input v-model="data.contact"></a-input>
          </p>
          <p class="item">
            <span class="label">電話</span>
            <a-input v-model="data.tel"></a-input>
          </p>
          <p class="item">
            <span class="label">傳真</span>
            <a-input v-model="data.fax"></a-input>
          </p>
          <p class="item">
            <span class="label">郵箱</span>
        ...
        <a-collapse-panel v-if="record.meta.length < 3" header="客戶聯絡人3" :key="3">
          <p class="item">
            <span class="label">聯絡人姓名</span>
            <a-input v-model="data.contact"></a-input>
          </p>
