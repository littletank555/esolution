    ...
    >
      <template slot="invoice" slot-scope="record">
        <router-link
          :to="{
            name: 'bidfile',
            params: { project_id: record.project_id,title:'發票'},
            query:{
             file_cat:0,
            },
          }"
        ...
        <router-link
          :to="{
            name: 'bidfile',
            params: { project_id: record.project_id,title:'收據'},
            query:{
             file_cat:1,
            },
          }"
      ...
      <template slot="spending" slot-scope="record">
        <router-link
          :to="{
            name: 'bidfile',
            params: { project_id: record.project_id,title:'應付'},
            query:{
             file_cat:2,
            },
          }"
        ...
        <router-link
          :to="{
            name: 'bidfile',
            params: { project_id: record.project_id,title:'未付'},
            query:{
             file_cat:3,
            },
          }"
