<template>
  ...
  >
    ...
    <p class="item">
      <span>發出日期</span>
      <a-date-picker style="width:100%" format="DD/MM/YYYY" v-model="info.send_date"></a-date-picker>
    </p>
    <p class="item">
      <span>報價</span>
    ...
    <p class="item">
      <span>報價日期</span>
      <a-date-picker style="width:100%" format="DD/MM/YYYY" v-model="info.receipt_date"></a-date-picker>
    </p>
