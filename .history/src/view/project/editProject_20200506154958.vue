...
export default {
  ...
  methods: {
    show(info) {
      ...
      this.info.in_price_date = getDate(this.info.re_tender_date);
      this.info.end_bid_date = getDate(this.info.in_bid_date);
      this.info.send_bid_date = getDate(this.info.end_tender_date);
      this.visible = true;
