...
const columns = [
  { title: "編號", dataIndex: "sort", width: 100 },
  { title: "負責同事", dataIndex: "sales_code", width: 200 },
  { title: "工程單編號", dataIndex: "p_no", width: 300 },
  { title: "客戶", dataIndex: "ccn", width: 650 },
  { title: "工程地點", dataIndex: "pl", width: 350 },
  { title: "工程標題", dataIndex: "pt", width: 1200 },
  { title: "ES中標日期", dataIndex: "re_bidding_date", width: 300 },
  { title: "ES中標價錢", dataIndex: "biding_price", width: 200 },
  { title: "中標分判名稱", dataIndex: "sub_bid_name", width: 300 },
  { title: "接收中標日期", dataIndex: "sub_re_bid_date", width: 300 },
  { title: "中標分判價錢", dataIndex: "sub_bid_price", width: 300 },
