  ...
  <a-modal v-model="visible" :footer="null" title="報標文件處理流程表" width="1000px">
    <div class="created_invitation">
      ...
      <a-card class="a-card">
        <p class="checkbox">
          <span class="label"></span>
          <a-checkbox v-model="send.sales_memo">「合約授予通知」</a-checkbox>
          <a-checkbox v-model="send.bid_notice">出空白「完工紙」</a-checkbox>
          <a-checkbox v-model="send.finished">出指明格式完工紙</a-checkbox>
        </p>
        <p class="checkbox">
          <span class="label"></span>
