  ...
  >
    <div class="new_client_data_container">
      ...
      <p class="item">
        ...
        <a-input v-model="client.bt" :disable="true"></a-input>
      </p>
      <p class="item">
        <span class="label">聯繫人</span>
        <a-input v-model="client.contact" :disable="true"></a-input>
      </p>
      <p class="item">
        <span class="label">電話</span>
        <a-input v-model="client.ct" :disable="true"></a-input>
      </p>
      <p class="item">
        <span class="label">傳真</span>
        <a-input v-model="client.cf" :disable="true"></a-input>
      </p>
      <p class="item">
        <span class="label">郵箱</span>
        <a-input v-model="client.ce" :disable="true"></a-input>
      </p>
      ...
      <a-collapse accordion>
        <a-collapse-panel header="客戶聯絡人" v-for="(item,i) in contact" :key="i">
          <p class="item">
            <span class="label">聯絡人姓名</span>
            <a-input v-model="contact.bt"></a-input>
          </p>
          <p class="item">
            <span class="label">電話</span>
