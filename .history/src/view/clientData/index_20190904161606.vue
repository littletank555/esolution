<template>
  <div class="client_list">
    <p class="header">
      <a-input-search placeholder="search by name" style="width: 200px;float:left;" @search="onSearch" />
      <a-button
        type="primary"
        @click="()=>{
...
const columns = [
  {
    title: "Client Data No.",
    dataIndex: "client_data_id",
    width: 200
  },
  {
    title: "施工地點中文名稱 (LC) Location Chinese",
    dataIndex: "lc",
    width: 200
  },
  {
    title: "施工地點英文名稱 (LE) Location English",
    dataIndex: "le",
    width: 200
  },
  {
    title: "地點序號 (LSN) Location Serial Numbe",
    dataIndex: "lsn",
    width: 200
  },
  {
